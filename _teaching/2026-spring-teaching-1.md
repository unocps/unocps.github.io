...
| 2  | Jan. 19  -   Jan. 25 | Martin Luther King Day (Student & Staff Holiday) - University Closed |  [Galileo System Receipt] <br> Reading: ch.2 & ch.3 <br> <a href="" style="color: blue"> Homework 1 Available</a>  |
| 3  | Jan. 26   -   Feb. 1 | [Xinu on Intel Galileo User Manual] <br> [Xinu Setup Procedure] <br>  [Organization of an Operating System] <br>[Organization of an Operating System] <br> [Hardware Architecture and Runtime Systems]   | Reading: ch.4 & ch.5  <br>  <span style="color:red"> **Project Topic Submission** <span style="color:black">  <br>  <a href="" style="color: blue">Program 1 Available</a> [stack_frame] <br> <span style="color:red"> Homework 1 Due (upload to Canvas) </span> <br>  <a href="" style="color: green">Homework 1 Solution</a>  |
