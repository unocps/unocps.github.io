...
|  Mon   |  Mar. 20  |   [Sensing and Perception in Simulation II] | <span style="color:red"> **[Project Checkpoint 2]** <span style="color:black"> (at least 2 pages submission each team) <br>  Reading: ch5, [Gazebo Tutorials Intermediate](http://gazebosim.org/tutorials?cat=guided_i&tut=guided_i1) |
...
| Wed	|  Apr. 5         |  	[Auto-Navigation Planner]	| <span style="color:red"> **[Project Checkpoint 3]** <span style="color:black"> (at least 2 pages submission each team) <br> Reading: Ch.8, [ROS Navigation Tutorials](http://wiki.ros.org/navigation) <br>  <a href="">Program 3 Available</a>    	|
