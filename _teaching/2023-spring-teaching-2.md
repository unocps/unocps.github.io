...
|  Mon   |   Mar. 27    |  [Planning: Representation and Fundamentals]  |  Reading: [URDF Tutorials](http://wiki.ros.org/urdf/Tutorials), [Using a URDF in Gazebo](http://wiki.ros.org/urdf/Tutorials/Using%20a%20URDF%20in%20Gazebo)   |
|  Wed   |  Mar. 29     |   [Planning: Representation and Fundamentals]    |   Reading: ch8 | 
...
|  Mon   |   Apr. 10 	|	[Auto-Navigation Planner]  	| Reading: Ch.7 <br> <a href="" style="color: blue">Program 4 Available</a>  <br> <span style="color:red"> **[Project Checkpoint 3]** <span style="color:black"> (at least 2 pages submission each team)   	|
