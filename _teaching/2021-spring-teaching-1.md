...
| Thur | Feb. 11 |   [Communication & Synchronization - Part 1]  | Reading: OSTEP: [Monitors](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-monitors.pdf) <br> <span style="color:red"> Homework 2 Due (Upload to Canvas) </span>  |
| Tue  | Feb. 16  |  [Communication & Synchronization - Part 2]    | Reading: ch.2.4 <br> [The Multi-Level Feedback Queue](http://pages.cs.wisc.edu/~remzi/OSTEP/cpu-sched-mlfq.pdf) <br>  <a href="" style="color: green">Homework 2 Solution</a>  |
