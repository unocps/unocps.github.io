...
| 3  | Feb. 5 - Feb. 9  | [Organization of an Operating System] <br> [Hardware Architecture and Runtime Systems]   | Reading: ch.4 & ch.5  <br>  <span style="color:red"> Submit Project Topics </span> <br>  <a href="" style="color: blue">Program 1 Available</a> <br> [stack_frame] <br> <span style="color:red"> Homework 1 Due (upload to Canvas) </span> <br> <a href="" style="color: blue">Homework 2 Available</a> |
