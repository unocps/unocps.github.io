...
| 3  | Feb. 5 - Feb. 9  | [Organization of an Operating System] <br> [Hardware Architecture and Runtime Systems]   | Reading: ch.4 & ch.5  <br>  <span style="color:red"> **Project Topic Submission** <span style="color:black">  <br>  <a href="" style="color: blue">Program 1 Available</a> [stack_frame] <br> <span style="color:red"> Homework 1 Due (upload to Canvas) </span> <br> <a href="" style="color: blue">Homework 2 Available</a> |
| 4  | Feb. 12 - Feb. 16  | [Hardware Architecture and Runtime Systems] | Reading: ch.5  & ch.6 <br>  <a href="" style="color: green">Homework 1 Solution</a>|
...
| 9  | Mar. 18 - Mar. 22 |  [Low-level Memory Management] <br> <span style="color:red"> **Project Progress Report** <span style="color:black"> (at least 2 page section submission each team)   | Reading: ch.10 & ch.11 & ch.12 <br> <a href="" style="color: blue">Program 2 Available</a>  |
...
| 14  | Apr. 22 - Apr. 26 |  [Networking Protocols]   <br>  <span style="color:red"> **Project Progress Report** <span style="color:black"> (at least 2 page section submission each team) | Reading: ch.16 & ch.17 <br>  <a href="" style="color: blue">Homework 5 Available</a> |
