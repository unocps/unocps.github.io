...
* CSCI4500-001: Students will attend once a week in-person (Location: Peter Kiewit Institute 274). Few day(s) may participate remotely synchronously learning if necessary.) 
...
| 5  |  Sep. 18  -   Sep. 22  |   [Threads & Concurrency]  	|	Reading: ch.4 <br> <a href="" style="color: blue">Homework 2 Available</a> ) <br> OSTEP: [Common Concurrency Problems, pages 1-11](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-bugs.pdf) (stop at "Deadlock Avoidance via Scheduling") |
| 6  |  Sep. 25  -   Sep. 29  |   [CPU Scheduling]       	|	Reading:  ch.5  <br> <span style="color:red"> Homework 2 Due (Upload to Canvas) </span> <br>  [CPU Scheduling](http://pages.cs.wisc.edu/~remzi/OSTEP/cpu-sched.pdf)  <br> [The Multilevel Feedback Queue](http://pages.cs.wisc.edu/~remzi/OSTEP/cpu-sched-mlfq.pdf)   |
| 7  |  Oct. 2  -   Oct. 6   	|   [Process Synchronization]   	|	Reading: ch.6	<br> <a href="" style="color: blue">Homework 3 Available</a>   <br> <span style="color:red"> **Program 1 Due, 11:59pm**</span>   <br>  <a href="" style="color: blue">Program 2 Available</a>   <br> OSTEP [Lock](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-locks.pdf)  (skip 28.8-28.11)  |
| 8  |  Oct. 9 - Oct. 13    |   [Synchronization Example]	| Reading: ch.7  <br>  <span style="color:red"> Homework 3 Due (Upload to Canvas)  </span> 	<br> OSTEP: [Monitors](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-monitors.pdf)   |
...
| 10  |  Oct. 23 - Oct. 27 	|   [Deadlocks]   | Reading: Ch.8  <br> <span style="color:red"> Homework 4 Due (Upload to Canvas) </span>  |
...
| 15  | Nov. 27 - Dec. 1  	|   [I/O Systems] <br> [Put It All Together ]     	|   Reading: Ch.12  <br> [Chapter 3](http://book.mixu.net/distsys/time.html)  <br>  <span style="color:red"> Homework 6 Due (Upload to Canvas) <br>	</span> **Program 3 Due  at 11:59pm** </span> 	|
