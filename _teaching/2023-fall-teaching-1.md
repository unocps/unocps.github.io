...
| 5  |  Sep. 18  -   Sep. 22  |    [Processes] <br> [Threads & Concurrency]  	|	Reading: ch.4 <br> <a href="" style="color: blue">Homework 2 Available</a> ) <br> OSTEP: [Common Concurrency Problems, pages 1-11](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-bugs.pdf) (stop at "Deadlock Avoidance via Scheduling") |
