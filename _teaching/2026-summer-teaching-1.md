...
## Late Policy
Homework and Programming Assignments are subject to late penalty. Here is the point deduction policy: <span style="color:red"> **20% deduction (late by 1 day), 40% deduction (late by 2 days), 80% deduction (late by 3 days), and no credit if late by more than three days.** </span>
...
| 3  |  June 1   -   June 7  |   [Processes]      | Reading: ch.3 & ch.4  <br> OSTEP: [Processes](https://pages.cs.wisc.edu/~remzi/OSTEP/cpu-intro.pdf) <br> [Process API](https://pages.cs.wisc.edu/~remzi/OSTEP/cpu-api.pdf)  <br> <span style="color:red"> Homework 2 Due (Upload to Canvas) </span> <br> <a href="" style="color: blue">Homework 3 Available</a>  <br>  <a href="" style="color: blue">Program 2 Available</a>   |
| 4  |  June 1   -   June 7  |   [Threads & Concurrency]         |    Reading:  ch.5  <br> OSTEP: [Common Concurrency Problems, pages 1-11](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-bugs.pdf) (stop at "Deadlock Avoidance via Scheduling")  |
| 5  |  June 8   -   June 14 |   [CPU Scheduling]       |    Reading: ch.6 <br> OSTEP: [The Multilevel Feedback Queue](http://pages.cs.wisc.edu/~remzi/OSTEP/cpu-sched-mlfq.pdf)    <br>  [CPU Scheduling](http://pages.cs.wisc.edu/~remzi/OSTEP/cpu-sched.pdf)  <br>  <span style="color:red"> Homework 3 Due (Upload to Canvas)  </span> <br>   <a href="" style="color: blue">Homework 4 Available</a>  <br>  <span style="color:red"> **Program 2 Due, 11:59pm**</span>   |
| 6  |  June 8   -   June 14  |  [Process Synchronization]    | Reading: ch.7  <br>   OSTEP: [Lock](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-locks.pdf)  (skip 28.8-28.11) <br> OSTEP: [Semaphores](https://pages.cs.wisc.edu/~remzi/OSTEP/threads-sema.pdf)  <br>   OSTEP: [Monitors](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-monitors.pdf)   <br> <span style="color:red"> **Midterm** </span> <!---[Review Notes](https://drive.google.com/file/d/1ck8nXZ-yrPi86NRrlHerbdLIEtxlYkWc/view?usp=sharing) <br>  --> <span style="color:red"> Anytime, 75 mins </span>  |
| 1-6  | June 12  |   <span style="color:red"> **Midterm** </span> <!---[Review Notes](https://drive.google.com/file/d/1ck8nXZ-yrPi86NRrlHerbdLIEtxlYkWc/view?usp=sharing) <br>  --> | Reading: textbook, supplemental materials, and all slides <br> <span style="color:red"> Anytime, 75 mins </span> |
| 7 |  June 15   -   June 21    |  [Synchronization Example]   | Reading: Ch.8  <br> <span style="color:red"> Homework 4 Due (Upload to Canvas) </span>    <br> <a href="" style="color: blue">Homework 5 Available</a>  <br> <a href="" style="color:blue"> Program 3 Available</a>  |
| 8  |   June 15   -   June 21  |  [Deadlocks]  |  Reading: ch.9  <br> OSTEP: [Common Concurrency Problems, pages 11-16](http://pages.cs.wisc.edu/~remzi/OSTEP/threads-bugs.pdf) ("Deadlock Avoidance via Scheduling")  |
| 9  |   June 22   -   June 26     | [Main Memory]      | Reading: ch.10 <br>  OSTEP: [Pages](https://pages.cs.wisc.edu/~remzi/OSTEP/vm-paging.pdf)  <br>  OSTEP: [Address Spaces](http://pages.cs.wisc.edu/~remzi/OSTEP/vm-intro.pdf)   |
...
| 1-10  | June 26  |   <span style="color:red"> [**Final Exam** ](https://www.unomaha.edu/registrar/students/after-enrollment/final-exam.php#tts2) </span> | Reading: textbook, supplemental materials, and all slides <br> <span style="color:red"> Anytime, 120 mins </span> |
