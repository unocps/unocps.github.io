...
| 4  |  June 1   -   June 7  |   [Threads & Concurrency]  <br> [CPU Scheduling]          |    Reading:  ch.5  <br>  [CPU Scheduling](http://pages.cs.wisc.edu/~remzi/OSTEP/cpu-sched.pdf)  <br> [The Multilevel Feedback Queue](http://pages.cs.wisc.edu/~remzi/OSTEP/cpu-sched-mlfq.pdf)   |
